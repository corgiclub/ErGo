...
__plugin_name__ = '爱狗QA'
__plugin_description__ = '召唤bot续写土味情话'
__plugin_usage__ = '发送“爱狗 ...”'
__plugin_pattern__ = '爱狗+'

INFERENCE_URL = "http://i.tech.corgi.plus:8866/predict/ernie_gen_lover_words"
TIMEOUT = 100
bcc = Get.bcc()
